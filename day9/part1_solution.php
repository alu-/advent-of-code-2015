...
$aLocations = file(realpath(__DIR__) . '/part1_input.txt', FILE_IGNORE_NEW_LINES);
...
$iShortestDistance = null;
$aShortestRoute = array();
foreach( generatorArrayPermutations($aUniqueLocations) as $aPermutation ) {
	...
	if( $iShortestDistance === null || $iDistance < $iShortestDistance) {
		$iShortestDistance = $iDistance;
		$aShortestRoute = $aPermutation;
	}
}

echo 'Shortest route: ', implode(' -> ', $aShortestRoute), PHP_EOL, 'Distance: ' . $iShortestDistance;
